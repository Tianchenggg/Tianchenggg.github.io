...
Queen Mary Prize uses a standalone crown SVG with padding, preserving the seven original crown paths from the locally stored university logo. The original full logo remains unchanged. The crown scales proportionally within its icon slot without overflow clipping or absolute positioning.
